--/// PUBLIC RELEASE ArizmaCL
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
local Window = Library.CreateLib("ArizmaCL,  Selamin Aleykim", "BloodTheme")
local CharacterTab = Window:NewTab("Karakter")
local PlayerTab = Window:NewTab("Aim")
local SettingsTab = Window:NewTab("Ayarlar")
local MovementSection = CharacterTab:NewSection("Hareketler")
local CharacterSection = CharacterTab:NewSection("Karakter")
local AimingSection = PlayerTab:NewSection("Lan Acma Lan Gardas")
local SettingsSection = SettingsTab:NewSection("Ayarlar")
    ...
    function()
        xpcall(
            ...
            function()
                ...
                warn("ArizmaCL is no longer running!")
            end
        )
    end
)